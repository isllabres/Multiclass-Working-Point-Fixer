...
def metrics_scanning_working_points(
    ...
    if plot:
        ...
        plt.plot(
            axis_working_points[pos_best_f1], precission_curve[pos_best_f1], "ob"
        )
        plt.plot(
            axis_working_points, precission_curve, label="Precission"
        )
        ...
        plt.plot(
            axis_working_points[pos_best_f1], recall_curve[pos_best_f1], "ob"
        )
